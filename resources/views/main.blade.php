            ...
            <ul class="lots__list">
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-1.jpg')}}" width="350" height="260" alt="Сноуборд">
                    </div>
                    <div class="lot__info">
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-2.jpg')}}" width="350" height="260" alt="Сноуборд">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category">Доски и лыжи</span>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-3.jpg')}}" width="350" height="260" alt="Крепления">
                    </div>
                    <div class="lot__info">
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-4.jpg')}}" width="350" height="260" alt="Ботинки">
                    </div>
                    <div class="lot__info">
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-5.jpg')}}" width="350" height="260" alt="Куртка">
                    </div>
                    <div class="lot__info">
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-6.jpg')}}" width="350" height="260" alt="Маска">
                    </div>
                    <div class="lot__info">
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="{{ asset('img/lot-6.jpg')}}" width="350" height="260" alt="Ботинки">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category">Ботинки</span>
                        <h3 class="lot__title"><a class="text-link" href="lot.html">Ботинки для сноуборда DC Mutiny Charocal</a>
